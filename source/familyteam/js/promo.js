...
})({"gvJfq":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "b73af03b0dfac0b0";
"use strict";
...
},{}],"k9hzb":[function(require,module,exports) {
...
var _blurFilterJs = require("./components/BlurFilter.js");
var _blurFilterJsDefault = parcelHelpers.interopDefault(_blurFilterJs);
...
var _hideShowJs = require("./components/HideShow.js");
var _hideShowJsDefault = parcelHelpers.interopDefault(_hideShowJs);
var _browserCheckJs = require("./components/BrowserCheck.js");
var _browserCheckJsDefault = parcelHelpers.interopDefault(_browserCheckJs);
VMasker(document.querySelectorAll("[phone-mask]")).maskPattern("9 (999) 999-9999");
let hideGood = new (0, _hideShowJsDefault.default)();
hideGood.open("[good-button]", "[good-content]");
...
(0, _videoJsDefault.default).start();
window.onresize = ()=>{
    (0, _backgroundJsDefault.default).renderOption();
};
window.onload = ()=>{
    (0, _backgroundJsDefault.default).renderOption();
    (0, _blurFilterJsDefault.default).start();
    (0, _browserCheckJsDefault.default).start();
};

},{"./components/Background.js":"iYsfk","./components/Video.js":"rk0Tt","./components/Carousel.js":"hSrRW","./components/BlurFilter.js":"8IOHT","./components/form/Form.js":"klRj7","./components/Popup.js":"jeOS7","./components/Faq.js":"1rEUJ","./components/HideShow.js":"aImPb","./components/BrowserCheck.js":"fEmFl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iYsfk":[function(require,module,exports) {
...
},{}],"rk0Tt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Video {
    // constructor() {
    ...
    // }
    //  start(video) {
    //     this.video = new videojs(video, {
    //         "controls": true,
    //         "poster": 'img/promo/promo-player-poster.png',
    ...
    // }
    // open() {
    //     let videos = document.querySelectorAll('[videojs]')
    //     if (!videos) return
    ...
    // }
    static start() {
        let videos_player = document.querySelectorAll("[video-player]");
        if (!videos_player) return;
        videos_player.forEach((el)=>{
            let video = el.querySelector("[video]");
            let poster = el.querySelector("[video-poster]");
            let controls = el.querySelector(".controls");
            let btn = el.querySelector("[video-play]");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8IOHT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class BlurFilter {
    static start() {
        let el = document.querySelectorAll(".filter-image");
        if (navigator.userAgent.includes("Firefox")) for(let i = 0; i < el.length; i++)el[i].classList.add("mozilla-filter");
        let el_bg = document.querySelectorAll(".filter-bg");
        if (navigator.userAgent.includes("Firefox")) for(let i = 0; i < el_bg.length; i++)el_bg[i].classList.add("mozilla-filter-bg");
    }
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aImPb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class HideShow {
...
exports.default = HideShow;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fEmFl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class BrowserCheck {
    static start() {
        let el = document.querySelectorAll("[browser-check]");
        if (el) {
            if (navigator.userAgent.includes("UCBrowser")) for(let i = 0; i < el.length; i++)el[i].classList.add("UCBrowser-bg");
        }
    }
}
exports.default = BrowserCheck;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gvJfq","k9hzb"], "k9hzb", "parcelRequire8e13")
